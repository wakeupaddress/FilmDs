...
class __TwigTemplate_137113428fecadd1b9cb96b84ee03a0dc939cd60479c1d87ba2052ce5a0bf170 extends \Twig\Template
{
    private $source;
    private $macros = [];
...
(isset($context["cfg_bookmark"]) || array_key_exists("cfg_bookmark", $context))) ? ([0 => "action bookmark", 1 => _gettext("Bookmark")]) : (null)), 7 => [0 => "text failed", 1 => _gettext("Query failed")], 8 => [0 => "text targetdb", 1 => _gettext("Database"), "extraSpan" => (($__internal_68aa442c1d43d3410ea8f958ba9090f3eaa9a76f8de8fc9be4d6c7389ba28002 =                 // line 42
...
";
    ...
    {
        return new Source("", "console/display.twig", "/var/www/html/public_html/phpMyAdmin/templates/console/display.twig");
    }
}
